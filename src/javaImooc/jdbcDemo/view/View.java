package javaImooc.jdbcDemo.view;

import javaImooc.jdbcDemo.action.GoddessAction;
...
/**
 * @Author:Donlin
 * @Description: 视图层，相当于前端，用于用于操作的界面
 * @Date: Created in 17:16 2018/1/7
 * @Version: 1.0
 */
public class View {
